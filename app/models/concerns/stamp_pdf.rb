module StampPdf
  ...
  def stamped
    ...
    document_content = put_evidence_stamp(document_content, self.position)
  ...
  def put_evidence_stamp(document_content, number)
    evidence_pdf_data = EvidencePdf.new(number).render
