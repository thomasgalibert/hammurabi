...
class FactureTest < ActiveSupport::TestCase
  test "les calculs de la facture sont corrects avec différents taux de TVA et des réductions" do
    ...
    ligne_tva_standard = FactoryBot.create(:ligne, :tva_standard, facture: facture)
    ligne_tva_reduite = FactoryBot.create(:ligne, :tva_reduite, facture: facture)
    ligne_avec_reduction = FactoryBot.create(:ligne, :tva_standard, :avec_reduction, facture: facture)
    ...
    assert_equal 3380, facture.total_cents
  end
end
